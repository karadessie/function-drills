...
*/
const jsNinja = lovesJavaScript => {
  lovesJavaScript = 'I am a Javascript ninja!'
  return lovesJavaScript
}
jsNinja()  
////////////////// PROBLEM 3 ////////////////////
/*
...
*/
var personsName = 'Cameron'

function printName(personsName) {
   console.log(personsName)
}
printName(personsName)
...
function nameCheck(coolName) {
    if (coolName = 'Steven') {
       console.log('What is up Steven?')
    }
    else if (coolName = 'Bryan') {
       console.log('Hey Bryan!')
    }
    else {
       console.log('Cool Name ' + coolName)
    }}
...
var bestMovie = 'Fiddler on the Roof'
const bestMovieFinder = (movie) => movie

console.log (bestMovieFinder(bestMovie))
